...
/* CONFIGURATION SECTION =================================================================== */
 ...
 string NomeGrafico = "B-on: max/2";
 string DrawOptionForAll = "APLF";
 
 //range di taglio per lo spettro (in forma generale)
 int TaglioXminM = 3515;
 int TaglioXmaxM = 5745;
 int TaglioYminM = 10;
 int TaglioYmaxM = 72;
 
 //range di taglio per lo spettro (zoom sui picchi di interesse)
 vector<unsigned int> SplitPoint{3515, 3636, 3747, 3870, 3985, 4108, 4228, 4350, 4465, 4595, 4716, 4845, 4970, 5100, 5223, 5355, 5478, 5620, 5745};
 vector<string> Letters{"A","B","C","D","E","F","G","H","I","J","K","L","M","N","O","P","Q","R"};
 vector<float> FitRangeLowerBound{ 3595, 3636, 3828, 3872, 4065, 4108, 4306, 4350, 4551, 4597, 4800, 4846, 5053, 5100, 5311, 5357, 5574, 5620};
 vector<float> FitRangeUpperBound{ 3636, 3670, 3872, 3907, 4108, 4146, 4350, 4388, 4597, 4634, 4846, 4885, 5100, 5140, 5357, 5396, 5620, 5659};
